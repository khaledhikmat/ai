...
from agent.incidents.agent import initialize_agent_params as init_inc_agent, finalize_agent_params as fin_inc_agent
...
async def main(agent_type: str):
    ...
    agent_params = await agent_init_fns[agent_type]()
